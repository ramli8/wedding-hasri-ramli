...
export default function DemoLoginPage() {
    ...
    const [email, setEmail] = useState('admin@gns-demo.com');
            ...
            <Card className="w-full max-w-md shadow-xl">
                <CardHeader className="space-y-1">
                    ...
                    <CardDescription className="text-center">
                        Demo Mode — Klik Sign In untuk masuk tanpa backend
                    </CardDescription>
                </CardHeader>
                <CardContent>
                ...
                <CardFooter>
                    <p className="text-center text-sm text-muted-foreground w-full">
                        ...
                        <Link href="/demo/auth/register" className="text-primary hover:underline font-medium">
                            Sign up
                        </Link>
                    </p>
                </CardFooter>
