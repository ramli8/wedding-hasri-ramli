...
const langId = {
  Common: {
    ...
    modules: {
      ...
      pengaturan_pernikahan: {
        title: 'Pengaturan Pernikahan',
        subtitle: 'Kelola data mempelai dan acara pernikahan',
      },
      personalisasi: {
        title: 'Personalisasi',
  ...
  Badge: {
    ModuleName: 'Badge',
    ModuleDescription:
      'Badge adalah indikator visual kecil yang dapat digunakan untuk menampilkan status, jumlah, atau mengkategorikan item.',
  },
  Button: {
    ModuleName: 'Button',
    ModuleDescription:
      'Button adalah elemen interaktif di web yang digunakan untuk memicu aksi atau respons saat diklik oleh pengguna.',
  },
  Card: {
    ModuleName: 'Card',
    ModuleDescription:
      'Card adalah elemen kontainer di web yang digunakan untuk menampilkan konten dalam format kartu.',
  },
  Menu: {
    ModuleName: 'Menu',
    ModuleDescription:
      'Menu adalah elemen navigasi di web yang digunakan untuk mengakses berbagai halaman atau fitur.',
  },
