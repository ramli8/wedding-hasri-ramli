...
const CheckOutPage = () => {
  ...
  const processCheckOut = useCallback(
    async (qrCode: string) => {
      console.log('Processing check-out for:', qrCode);
      setLoading(true);
      setResultType(null);
      setResultMessage('');
      ...
      try {
        ...
        const response = await tamuAPI.directCheckOut(qrCode);
        ...
        if (response.success && response.guest) {
          ...
          setResultMessage('Terima kasih sudah datang!');
              ...
              <Box mb={6} px={{ base: 2, md: 0 }}>
                <VStack spacing={1} align="start">
                  ...
                  <Text fontSize="xs" color="gray.500">
                    Arahkan kamera ke QR Code tamu untuk melakukan check-out
                  </Text>
                  {!isSecure && (
